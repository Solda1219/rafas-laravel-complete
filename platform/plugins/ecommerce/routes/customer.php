...
Route::group([
    ...
    Route::get('phoneUnique', 'RegisterController@phoneUnique')->name('phoneUnique');
    ...
    Route::post('passwordReset', 'ResetPasswordController@passwordReset')->name('password.phone');
